...
public:
     ...
     */
    QList<QUrl> events() const {
        QList<QUrl> value;
        foreach(const QVariant& v, property(QUrl::fromEncoded("http://www.example.com/nbib#event", QUrl::StrictMode)))
            value << v.value<QUrl>();
        return value;
    }
     ...
     * this publication was shown, represented, published etc 
     */
    void setEvents(const QList<QUrl>& value) {
        QVariantList values;
    ...
    /**
     * Get property http://www.example.com/nbib#type. The type 
     * of tech-report or other kind of Publication, for example, 'Research 
     * Note'. 
     */
    QString type() const {
        QString value;
        if(contains(QUrl::fromEncoded("http://www.example.com/nbib#type", QUrl::StrictMode)))
            value = property(QUrl::fromEncoded("http://www.example.com/nbib#type", QUrl::StrictMode)).first().value<QString>();
        return value;
    }

    /**
     * Set property http://www.example.com/nbib#type. The type 
     * of tech-report or other kind of Publication, for example, 'Research 
     * Note'. 
     */
    void setType(const QString& value) {
        QVariantList values;
        values << value;
        setProperty(QUrl::fromEncoded("http://www.example.com/nbib#type", QUrl::StrictMode), values);
    }

    /**
     * Add value to property http://www.example.com/nbib#type. 
     * The type of tech-report or other kind of Publication, for example, 
     * 'Research Note'. 
     */
    void addType(const QString& value) {
        addProperty(QUrl::fromEncoded("http://www.example.com/nbib#type", QUrl::StrictMode), value);
    }
    ...
    qint64 volume() const {
        ...
        if(contains(QUrl::fromEncoded("http://www.example.com/nbib#volume", QUrl::StrictMode)))
            value = property(QUrl::fromEncoded("http://www.example.com/nbib#volume", QUrl::StrictMode)).first().value<qint64>();
        return value;
    }
     ...
     * of a journal or multi-volume book. 
     */
    void setVolume(const qint64& value) {
        QVariantList values;
        values << value;
     ...
     */
    void addVolume(const qint64& value) {
