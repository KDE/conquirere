 ...
 */
class Alarm : public virtual NCAL::UnionOfAlarmEventFreebusyTodo, public virtual NIE::InformationElement, public virtual NCAL::UnionOfAlarmEventJournalTodo, public virtual NCAL::UnionOfAlarmEventFreebusyJournalTodo, public virtual NCAL::UnionOfAlarmEventTodo
{
public:
    Alarm(const QUrl& uri = QUrl())
      : SimpleResource(uri), NCAL::UnionParentClass(uri, QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/04/02/ncal#Alarm", QUrl::StrictMode)), NCAL::UnionOfAlarmEventFreebusyTodo(uri, QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/04/02/ncal#Alarm", QUrl::StrictMode)), NIE::InformationElement(uri, QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/04/02/ncal#Alarm", QUrl::StrictMode)), NCAL::UnionOfAlarmEventJournalTodo(uri, QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/04/02/ncal#Alarm", QUrl::StrictMode)), NCAL::UnionOfAlarmEventFreebusyJournalTodo(uri, QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/04/02/ncal#Alarm", QUrl::StrictMode)), NCAL::UnionOfAlarmEventTodo(uri, QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/04/02/ncal#Alarm", QUrl::StrictMode)) {
    }

    Alarm(const SimpleResource& res)
      : SimpleResource(res), NCAL::UnionParentClass(res, QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/04/02/ncal#Alarm", QUrl::StrictMode)), NCAL::UnionOfAlarmEventFreebusyTodo(res, QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/04/02/ncal#Alarm", QUrl::StrictMode)), NIE::InformationElement(res, QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/04/02/ncal#Alarm", QUrl::StrictMode)), NCAL::UnionOfAlarmEventJournalTodo(res, QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/04/02/ncal#Alarm", QUrl::StrictMode)), NCAL::UnionOfAlarmEventFreebusyJournalTodo(res, QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/04/02/ncal#Alarm", QUrl::StrictMode)), NCAL::UnionOfAlarmEventTodo(res, QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/04/02/ncal#Alarm", QUrl::StrictMode)) {
    }
...
protected:
    Alarm(const QUrl& uri, const QUrl& type)
      : SimpleResource(uri), NCAL::UnionParentClass(uri, type), NCAL::UnionOfAlarmEventFreebusyTodo(uri, type), NIE::InformationElement(uri, type), NCAL::UnionOfAlarmEventJournalTodo(uri, type), NCAL::UnionOfAlarmEventFreebusyJournalTodo(uri, type), NCAL::UnionOfAlarmEventTodo(uri, type) {
    }
    Alarm(const SimpleResource& res, const QUrl& type)
      : SimpleResource(res), NCAL::UnionParentClass(res, type), NCAL::UnionOfAlarmEventFreebusyTodo(res, type), NIE::InformationElement(res, type), NCAL::UnionOfAlarmEventJournalTodo(res, type), NCAL::UnionOfAlarmEventFreebusyJournalTodo(res, type), NCAL::UnionOfAlarmEventTodo(res, type) {
    }
};
}
}
