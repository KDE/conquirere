...
public:
    Filesystem(const QUrl& uri = QUrl())
      : SimpleResource(uri), NFO::DataContainer(uri, QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nfo#Filesystem", QUrl::StrictMode)) {
    }

    Filesystem(const SimpleResource& res)
      : SimpleResource(res), NFO::DataContainer(res, QUrl::fromEncoded("http://www.semanticdesktop.org/ontologies/2007/03/22/nfo#Filesystem", QUrl::StrictMode)) {
    }
