...
void ProjectTreeWidget::addLibrary(Library *p)
...
void ProjectTreeWidget::closeLibrary(Library *p)
{
...
void ProjectTreeWidget::fetchDataFor(ResourceSelection selection, bool start, Library *p)
{
