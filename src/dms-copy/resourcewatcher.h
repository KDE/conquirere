...
namespace Nepomuk {
    ...
    public:
         ...
         * \sa setProperties()
         */
        void addProperty( const Nepomuk2::Types::Property & property );
         ...
         * \sa setTypes()
         */
        void removeType( const Nepomuk2::Types::Class & type );
         ...
         * \sa setProperties()
         */
        void removeProperty( const Nepomuk2::Types::Property & property );
